...
const TimeTableIcon = ({ link }) => {
    const location = useLocation();
    const stroke =location.pathname == link ? "#3366FF" : "#8F9BB3"
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.05 2.52979L4.03002 6.45979C2.10002 7.71979 2.10002 10.5398 4.03002 11.7998L10.05 15.7298C11.13 16.4398 12.91 16.4398 13.99 15.7298L19.98 11.7998C21.9 10.5398 21.9 7.72979 19.98 6.46979L13.99 2.53979C12.91 1.81979 11.13 1.81979 10.05 2.52979Z" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
